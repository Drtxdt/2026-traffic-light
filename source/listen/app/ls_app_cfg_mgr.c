 ...
 * ptr			解析元素指针
 * count		解析元素数量
 * keyword		需要解析keyword时传入，否则传NULL
 * all_wake		是否支持同时唤醒 true 支持 false 不支持
 * current_wakeid   当前唤醒词id
 * is_waked     传出是否唤醒
 * return		ture 解析为此命令，false 解析不为此命令
*/
